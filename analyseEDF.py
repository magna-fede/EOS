...
ax = sns.regplot(data=nrgrffd_all[17][nrgrffd_all[17]['ms']>0], x='Sim',y='ms')
ax.set_title('First Fixation duration - Cloze SemanticSimilarity', fontsize = 15);

bx = sns.regplot(data=nrgrffd_all[17][nrgrffd_all[17]['ms']>0], x='cloze',y='ms')
bx.set_title('First Fixation duration - Cloze', fontsize = 15);

cx = sns.regplot(data=nrgrffd_all[17][nrgrffd_all[17]['ms']>0], x='LogFreq(Zipf)',y='ms')
cx.set_title('First Fixation duration - LogFrequency (Zipf)', fontsize = 15);

dx = sns.regplot(data=norm_nrgrffd_all[17][norm_nrgrffd_all[17]['ms']>0], x='ConcM',y='ms')
dx.set_title('First Fixation duration - Concreteness', fontsize = 15);

ex = sns.regplot(data=norm_nrgrffd_all[17][norm_nrgrffd_all[17]['ms']>0], x='mink3_SM', y='ms')
...
with open("U:/AnEyeOnSemantics/midanalysis/nrgr_ffd_all.P", 'wb') as outfile:
...
with open("U:/AnEyeOnSemantics/midanalysis/wrgr_ffd_all.P", 'wb') as outfile:
    pickle.dump(participants,outfile)  
...
with open("U:/AnEyeOnSemantics/midanalysis/nrgr_gd_all.P", 'wb') as outfile:
    pickle.dump(participants,outfile)  
...
with open("U:/AnEyeOnSemantics/midanalysis/wrgr_gd_all.P", 'wb') as outfile:
    pickle.dump(participants,outfile)  
...
with open("U:/AnEyeOnSemantics/midanalysis/norm_nrgr_ffd_all.P", 'wb') as outfile:
    pickle.dump(participants,outfile)  
...
with open("U:/AnEyeOnSemantics/midanalysis/norm_wrgr_ffd_all.P", 'wb') as outfile:
    pickle.dump(participants,outfile)  
...
with open("U:/AnEyeOnSemantics/midanalysis/norm_nrgr_gd_all.P", 'wb') as outfile:
    pickle.dump(participants,outfile)  
...
with open("U:/AnEyeOnSemantics/midanalysis/norm_wrgr_gd_all.P", 'wb') as outfile:
    pickle.dump(participants,outfile)  