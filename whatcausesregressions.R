...
################ trial number (order) ###############
trialsFFD3 = glmer(regressed ~ trialnrscaled + (1|ID) + (1|Subject), data = FFD3, family=binomial)
summary(trialsFFD3)
# the trial number affects the probability of making a regression

################ length preceding word ###############
lenPREC_FFD3 = glmer(regressed ~ LENprec + (1|ID) + (1|Subject), data = FFD3, family=binomial)
summary(lenPREC_FFD3)
# the length of the preceding word affects the probability of making a regression

################ length word ###############
lenFFD3 = glmer(regressed ~ LEN + (1|ID) + (1|Subject), data = FFD3, family=binomial)
summary(lenFFD3)
# length does not affects the probability of making a regression

################ zipf value of the word ###############
freqFFD3 = glmer(regressed ~ LogFreqZipf + (1|ID) + (1|Subject), data = FFD3, family=binomial)
summary(freqFFD3)
# frequency does not affect the probability of making a regression

################ Position ###############
posFFD3 = glmer(regressed ~ Position + (1|ID) + (1|Subject), data = FFD3, family=binomial)
summary(posFFD3)
# Position affects the probability of making a regression

npfFFD3 = glmer(regressed ~ n_prior_fix + (1|ID) + (1|Subject), data = FFD3, family=binomial)
summary(npfFFD3)

################ this is our basic model ###############
lmerBasic = glmer(regressed ~ n_prior_fix + trialnrscaled + LENprec + Position + (1|ID) + (1|Subject), data = FFD3, family=binomial)
summary(lmerBasic)
# not including Frequency

################ plausibility of the sentence ###############
plauFFD3 = glmer(regressed ~ n_prior_fix + trialnrscaled + LENprec + Position + plausibility + (1|ID) + (1|Subject), data = FFD3, family=binomial)
summary(plauFFD3)
# plausibility of the sentence affects the probability of making a regression

################ cloze probability ###############
clozeFFD3 = glmer(regressed ~ n_prior_fix + trialnrscaled + LENprec + Position + cloze + (1|ID) + (1|Subject), data = FFD3, family=binomial)
summary(clozeFFD3)
# cloze affects the probability of making a regression

################ cloze semantic similarity ###############
semSimFFD3 = glmer(regressed ~ n_prior_fix + trialnrscaled + LENprec + Position + Sim + (1|ID) + (1|Subject), data = FFD3, family=binomial)
summary(semSimFFD3)
...
################ concreteness ###############
concMFFD3 = glmer(regressed ~ n_prior_fix + trialnrscaled + LENprec + Position + ConcM + (1|ID) + (1|Subject), data = FFD3, family=binomial)
summary(concMFFD3)
# ConcM affects the probability of making a regression

################ concreteness ###############
additive = glmer(regressed ~ n_prior_fix + trialnrscaled + LENprec + Position + Sim + ConcM + (1|ID) + (1|Subject), data = FFD3, family=binomial)
summary(additive)

interactive = glmer(regressed ~ n_prior_fix + trialnrscaled + LENprec + Position + Sim * ConcM + (1|ID) + (1|Subject), data = FFD3, family=binomial)
summary(interactive)
